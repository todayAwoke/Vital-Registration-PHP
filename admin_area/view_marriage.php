...
<body>
    <div class ="container">
<h1 class="text-center  text-success">All marriages </h1>
<table class="table table-bordered bg-info mt-4">
    ...
    <tbody class="bg-secondary text-light">
        ...
        $get_product = "SELECT * from marriagees ";
        ...
        ?>
            <tr class='text-center'>
                ...
                <td> <a href='index.php?marriage_card=<?php echo $marriage_id ?>' class='text-light'> give card </a> </td>
                <td> <a href='index.php?edit_marriage=<?php echo $marriage_id ?>' class='text-light'> <i class='fa-solid fa-pen-to-square'></i></a> </td>
                <td> <a href='index.php?delete_marriage=<?php echo $marriage_id ?>' <button  class=" text-light " data-toggle="modal" data-target="#exampleModal"> </button> <i class='fa-solid fa-trash'></i></a> </td>
